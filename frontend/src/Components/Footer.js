    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        <h1>Contact Us</h1>
                        <p>Librarian</p>
                        <p>Ramdooth college eductionof </p>
                        <p>Saharanpur</p>
                        <p>uttar Pradesh</p>
                        <p>India</p>
                        <p><b>Email:</b>asaini7687.com</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2025 copyright all right reserved<br /><span>Designed with ❤️ by Pranavdhar Reddy</span></p>
            </div>
        </div>
    )
}
